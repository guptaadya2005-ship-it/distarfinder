...
function RiskMap() {
  ...
  const filteredZones =
    filter === "All"
      ? riskZones
      : riskZones.filter((zone) => zone.risk === filter);
          ...
          <div className="relative h-[650px] overflow-hidden rounded-2xl border border-slate-200 bg-slate-950 shadow-sm">
            ...
            <div
              ...
              style={{
                ...
                `,
                backgroundSize: "45px 45px, 45px 45px, 100% 100%, 100% 100%, 100% 100%",
              }}
            />
            ...
            <div className="absolute right-5 top-5 z-20 flex flex-col overflow-hidden rounded-xl border border-white/10 bg-slate-950/80 backdrop-blur">
              ...
              <button className="p-3 text-slate-300 hover:bg-slate-800">
                <Plus size={18} />
              </button>
            ...
            {selectedZone && (
              <div className="absolute bottom-5 right-5 z-30 w-[350px] rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  ...
                  <button className="flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-3 py-3 text-xs font-semibold text-white transition hover:bg-slate-800">
                    Analyze Risk
                    <ArrowUpRight size={14} />
                  </button>

                  <button className="flex items-center justify-center gap-2 rounded-xl bg-red-500 px-3 py-3 text-xs font-semibold text-white transition hover:bg-red-600">
                    Generate Alert
